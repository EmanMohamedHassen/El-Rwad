...
namespace SmartGate.ElRwad.WebAPI.Areas.HR.Controllers
{
    ...
    public class EmployeesController : ApiController
    {
        ...
        {
            var employee = db.Employees.Where(e => e.IsActive == isActive).Select(s => new
            {
                empId = s.Employee_ID,
                empPrintCode = s.Employee_Code,
                fullName = s.FullName,
        ...
        {
            var employee = db.Employees.Where(e => e.IsActive == true).Select(s => new
            {
                empPrintCode = s.Employee_Code,
                fullName = s.FullName,
                phone = s.Phone,
        ...
        {
            var returnEmpsData = listEmployees.Where(e => e.IsActive == true).Select(s => new
            {
                empId = s.Employee_ID,
                empPrintCode = s.Employee_Code,
                fullName = s.FullName,
